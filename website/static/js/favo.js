...
if (localStorage.getItem("username")) {
	...
	login.value = "Participate This Event";

	$("#ptc").click(function(){
			//sending request to UserServlet
			eid = document.getElementById("eid").innerHTML;
			var url = ipaddress + "participates?uid="+localStorage.getItem("username")+"&eid="+eid;
			...
			xhr.onreadystatechange = function() {
				...
				if (xhr.readyState == 4 && xhr.status == 200) {
					...
					if (response == "yes"){
						...
						alert("Sorry You Already Participate!");
				}
